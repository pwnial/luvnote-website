...
import { Scene, OrthographicCamera, WebGLRenderer, PlaneGeometry, ShaderMaterial, Mesh, Vector2, Vector3, Color } from 'three';
...
export default function PixelSnow({
  ...
  useEffect(() => {
    ...
    (material.uniforms.uColor.value as Vector3).copy(colorVector);
